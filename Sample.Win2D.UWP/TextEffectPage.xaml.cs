...
namespace Sample.Win2D.UWP
{
    public sealed partial class TextEffectPage : Page
    {
        ...
        {
            new BuiltInEffect("Advanced", new AdvanceEffectFX().ApplyGlowEffect(Colors.Red).ApplyOutlineEffect(Colors.AliceBlue).ApplyGlyphEffect(Colors.Green, Colors.Orange)),            
